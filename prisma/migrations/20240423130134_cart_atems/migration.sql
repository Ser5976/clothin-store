/*
  ...
  - Added the required column `color` to the `CartItems` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `size` to the `CartItems` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `cartitems` ADD COLUMN `color` VARCHAR(191) NOT NULL,
